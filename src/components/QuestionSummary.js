        ...
        <div className='question'>
            ...
            <div className='question-info'>
                <div>
                    ...
                    <h3>Results:</h3>
                    <div>
                        <h3>Would you rather {question.optionOne.text} { question.optionOne.votes.includes(authedUser) && <Fragment>(Your vote) </Fragment>}</h3>
                        <p>{(question.optionOne.votes.length * 100 /totalVotes).toFixed(2)} % : {question.optionOne.votes.length} out of {totalVotes} </p>
                    </div>
                    <div>
                        <h3>Would you rather {question.optionTwo.text} { question.optionTwo.votes.includes(authedUser) && <Fragment>(Your vote)</Fragment>}</h3>
